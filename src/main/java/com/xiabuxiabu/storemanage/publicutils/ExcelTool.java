...
public class ExcelTool<T> {
    ...
    private SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd"); //日期格式化,默认yyyy-MM-dd
    /**
     * 有参数 初始化 对象
     * @param title
     * @param colWidth
...
//            else  cLen--;
   ...
   /* public  HSSFWorkbook exportWorkbook(List<Column> listTpamscolumn, List<T> datas , boolean flag) throws Exception{
    ...
    public void export(OutputStream out,List<Column> listTpamscolumn,List<T> datas,boolean flag ) throws Exception{
        splitDataToSheets(datas, listTpamscolumn,flag,false);
